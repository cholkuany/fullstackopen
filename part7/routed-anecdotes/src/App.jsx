    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          ...
          <button type='button' onClick={content.reset}>clear</button>
        </div>
        <div>
          author <input { ...author.attributes } />
          <button type='button' onClick={author.reset}>clear</button>
        </div>
        <div>
          url for more info <input { ...info.attributes } />
          <button type='button' onClick={info.reset}>clear</button>
        </div>
